...
def normalize(ifile, tool : str, database : str, skip_on_unsupported_tool : bool, tool_version : bool):
    ...
    elif normalizer == AMRFinderPlusNormalizer:
        norm = normalizer(database=database, tool_version=tool_version)
    else:
